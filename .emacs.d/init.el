...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multiple-cursors exec-path-from-shell magit powerline helm with-editor websocket railscasts-theme magit-popup inflections inf-ruby dimmer diminish async dakrone-light-theme groovy-mode white-sand-theme multi-term markdown-preview-mode markdown-mode zenburn-theme undo-tree todotxt tango-2-theme rinari jekyll-modes jdee htmlize color-theme-mgl color-theme-solarized color-theme-sanityinc-tomorrow atom-dark-theme ace-jump-mode)))
 '(remember-data-file "~/mike-maheu/gtd/reminders.org")
 '(show-paren-mode t)
 '(term-default-bg-color "#121212")
